...
Any method calls must be checked that the equality constraints can be maintained in the 
new context of the method being called. This is done by checking that for each constraint listed on the 
method ($T=U$) T and U are \emph{equal-to} in the current context.
