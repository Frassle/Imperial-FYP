...
The type system of the CLI is covered in more detail later, but briefly.

\subsubsection{The virtual execution system}

The virtual execution system defines 




There are many other parts of the CLI that we haven't looked at. These include
things such as initialization guarantees, object layouts, serialization and
others. These do not have a direct effect on the extensions we discuss, and so
to save time we skip them.  There are many resource available if you wish to
understand a keyword or feature that I haven't explained.
