...
and exposed to these languages. We show how the system can easily be 
enhanced with type equality constraints, and discuss some issues and solutions
to allow values as type parameters.
\end{abstract}
