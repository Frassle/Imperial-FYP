...
Section 9.11 (Constraints on generic parameters)\cite{ecma-335} specifies
...
Conceptually, each row in the GenericParamConstraint table is =owned\textquoteleft{}
